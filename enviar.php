<?php
    ...
    if(empty($_POST['g-recaptcha-response'])):
        ...
        if ($data->success != '1'):
            ...
            if ( empty($formnome) || empty($formemail) || empty($formfone) || empty($formcelular) || empty($formassunto) | empty($formmensagem) ) :
                $campos = array();
            ...
            elseif ( !filter_var($formemail, FILTER_VALIDATE_EMAIL) ) :
                ...
                <strong>Celular:</strong> $formcelular<br>
                <strong>Assunto:</strong> $formassunto<br></p>
                <p>
                $formmensagem</p>";
                $mensagem .= "<hr>";
